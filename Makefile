...
# -fno-omit-frame-pointer allolabradoodws stack traces to be generated
...
# -s INITIAL+_MEMORY sets the initial amount of memory
...
EMCC_FLAGS = --preload-file assets --use-preload-plugins -s EXIT_RUNTIME=1 -s ALLOW_MEMORY_GROWTH=1 -s  INITIAL_MEMORY=655360000 -s USE_SDL=2 -s USE_SDL_GFX=2 -s USE_SDL_IMAGE=2 -s SDL2_IMAGE_FORMATS='["png"]' -s USE_SDL_TTF=2 -s USE_SDL_MIXER=2 -s ASSERTIONS=1 -O2 -g -gsource-map --source-map-base http://localhost:8000/bin/ -I/mnt/c/Users/purvi/Downloads/game-weasley-Final-Temp/emsdk/upstream/emscripten/system/include/SDL
